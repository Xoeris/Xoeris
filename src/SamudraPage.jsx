...
export default function SamudraPage({ onNavigate }) {
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="aspect-square w-full bg-[#151518] rounded-[2rem] border border-white/5 relative overflow-hidden flex items-center justify-center">
               ...
               <div className="absolute top-[20%] left-[20%] w-2 h-2 bg-green-400 rounded-full animate-pulse delay-300 shadow-[0_0_10px_#4ade80]"></div>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex justify-between items-center">
              ...
              <button className="p-2 bg-white/5 rounded-full"><TrendingUp size={20} className="text-green-500" /></button>
            </div>
            <div className="space-y-4">
              {[
                ...
                { name: 'Layang', price: 'Rp 28k', trend: '+1.4%', up: true },
              ].map((fish, i) => (
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-[#151518] p-6 rounded-3xl border border-white/5 space-y-4">
              <p className="text-gray-400 text-sm">SAMUDRA adalah sistem informasi nelayan terintegrasi yang mendukung kegiatan di laut dengan fitur:</p>
  ...
  return (
    <div className="fixed inset-0 bg-[#0A0A0B] text-white font-sans flex flex-col overflow-hidden">
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-[#0A0A0B]/95 backdrop-blur-2xl border-t border-white/5 px-6 py-4 flex justify-between items-center z-[100] safe-area-bottom shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        <button
        ...
        >
          <Activity size={activeTab === 'dashboard' ? 26 : 24} />
        ...
        >
          <MapPin size={activeTab === 'map' ? 26 : 24} />
        ...
        >
          <TrendingUp size={activeTab === 'market' ? 26 : 24} />
        ...
        >
          <Info size={activeTab === 'info' ? 26 : 24} />
